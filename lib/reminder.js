...
class Reminder {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            this.db.find({}, (err, reminders) => {
                ...
                resolve(reminders.forEach(reminder => {
                    this.schedule(reminder.channel_id, reminder.cron, reminder.text, reminder.author_id)
        ...
        return new Promise((resolve, reject) => {
            this.db.count({}, (err, count) => {
                if(err) reject(err)
                    ...
                    this.schedule(channelId, cronScheme, text, authorId)
    ...
    async schedule(channel_id, cron_scheme, text, author_id) {
        const author = this.client.users.get(author_id)

        return schedule.scheduleJob(cron_scheme, () => {
            try{
                this.speech.embedMsg(channel_id, {embed: {
